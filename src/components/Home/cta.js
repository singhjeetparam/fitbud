...
export  function CTA() {
    return (
      <div className="relative bg-white py-16">
        <div className="mx-auto max-w-7xl bg-cyan-500 lg:bg-transparent lg:px-8">
              ...
              <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-none lg:p-0">
                <div className="aspect-h-6 aspect-w-10 sm:aspect-h-1 sm:aspect-w-2 lg:aspect-w-1">
                  {/* <img
                    ...
                    alt=""
                  /> */}
                  <Image src="/cta.webp" className="rounded-3xl object-cover object-center shadow-2xl" fill />
                </div>
              </div>
            </div>
  
            <div className="relative bg-cyan-500 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
              <div className="absolute inset-0 hidden overflow-hidden rounded-3xl lg:block" aria-hidden="true">
                ...
                >
                  <defs>
                    ...
                    >
                      <rect x={0} y={0} width={4} height={4} className="text-cyan-600" fill="currentColor" />
                    </pattern>
                  </defs>
